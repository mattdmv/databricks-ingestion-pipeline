...
The 'ingestion_pipelines' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ingestion_pipelines_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/ingestion_pipelines.job.yml). The schedule
